        ...
        <div className="w-full shadow-navbarShadow h-18 lg:h-[06vh] sticky top-0 z-50 bg-bodyColor px-4">
            <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
                ...
                <div className="hidden mdl:inline-flex items-center gap-7">
                    ...
                    {/* RESUME BUTTON */}
                    <a href="/assets/Resume-Alamin-H.pdf" target="_blank">
                        <motion.button
                        initial={{ y: -10, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                          ...
                          >
                            <MdOutlineClose  
                              ...
                              <div className="w-[80%] flex flex-col text-base text-center items-center gap-8">
                                ...
                                {/* RESUME BUTTON */}
                                <a 
                                  href="/assets/Resume-Alamin-H.pdf" 
                                  target="_blank"
                                  className="pt-8"
                                >
                                    <motion.button
                                ...
                                <motion.a
                                  ...
                                  href="https://www.linkedin.com/in/alamin-h/" target='_blank'>
                                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300'>
                                    <BsLinkedin />
                                    </span>
                                </motion.a>
                                ...
                                <motion.a
                                  ...
                                  href="https://twitter.com/AlaminH0ssain" target='_blank'>
                                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300'>
                                    <TiSocialTwitter />
                                    </span>
                                </motion.a>
                                ...
                                <motion.a 
                                  href="mailto:itsalamin999@gmail.com"
                                  initial={{ x: 20, opacity: 0 }}
                                  animate={{ x: 0, opacity: 1 }}
                                  transition={{ 
                                    duration: 0.2, 
