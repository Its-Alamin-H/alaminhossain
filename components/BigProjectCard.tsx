      ...
      <div 
        ...
        <div className='bg-no1 hover:shadow-xl shadow-inner bg-no-repeat bg-cover bg-center bg-fixed flex-col rounded-lg mdl:hidden mx-5'>
          ...
          className='w-fit px-5 z-10 flex flex-col gap-6 mx-3'>
            ...
            The AI Integrated Discord Bot is a cutting-edge project that combines artificial intelligence (AI) capabilities with the popular communication platform <span className='text-textGreen'>Discord.</span> This bot leverages advanced natural language processing and <span className='text-textGreen'> machine learning algorithms</span> to provide seamless conversation interactions, and information.
            </p>
            {/* list of tech used */}
